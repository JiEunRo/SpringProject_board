...
<%@include file="../includes/header.jsp" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gallery Board List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<div class="row">
								<%
									int newLine = 0 , articleCouont = 0 , cnt = 0;
								%>
								<c:forEach items="${list}" var="board">
									...
									%>
										...
										<div class="thumbnail">
											<div class="thumpic">
												<div class="thumBno" style="display:none"><c:out value="${board.bno}" /></div>			
											</div>
											
											<div class="caption">
												<h3>#<c:out value="${board.bno}" /> <c:out value="${board.title}" /></h3>
												<p>
													reply. <c:out value="${board.replycnt}" /><br>
													wr. <c:out value="${board.writer}" /> <br>
													date. <fmt:formatDate pattern="yyyy-MM-dd" value="${board.regdate}" /> <Br>
													hit. <c:out value="${board.hit}" />
												</p>
												<p><a href="<c:out value='${board.bno}' />" class="move btn btn-primary" role="button">View</a></p>
											</div>
										</div>
